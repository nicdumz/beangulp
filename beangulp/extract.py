...
def find_duplicate_entries(extracted, existing):
    ...
    for filepath, entries, account, importer in extracted:
        ...
        accumulated_existing.sort(key=operator.attrgetter('date'))

        # Find duplicates.
        pairs = similar.find_similar_entries(entries, accumulated_existing)
        ...
        accumulated_existing.extend(marked)
